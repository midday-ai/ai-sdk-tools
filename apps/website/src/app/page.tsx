          ...
          <div className="space-y-12">
            ...
            <div className="flex flex-col gap-2 max-w-sm">
              {[
                ...
                >
                  <span className="text-[#d4d4d4] text-xs font-mono">npm i {pkg}</span>
                  <button
                    type="button"
                    onClick={() => navigator.clipboard.writeText(`npm i ${pkg}`)}
           ...
           <div className="relative h-[500px] w-full" style={{ perspective: '1000px' }}>
            ...
            >
              <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] p-1 shadow-2xl ">
                <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-2 ">
                  <div className="text-xs text-secondary mb-2">◇ AI SDK Store</div>
                  <LiveDemo />
                </div>
              </div>
            </div>
            ...
            <div 
              ...
              style={{
                transform: focusedDemo === 'devtools' 
                  ? 'rotateY(-2deg) rotateX(-1deg)' 
                  : 'rotateY(-6deg) rotateX(-3deg)',
                transformStyle: 'preserve-3d',
                backfaceVisibility: 'hidden'
            ...
            >
              <div className="bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] p-1 shadow-2xl ">
                <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-2 ">
                  <div className="text-xs text-secondary mb-2">◇ AI SDK Devtools</div>
                  <DevtoolsDemo />
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-40">
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Powerful Zustand-based state management for AI applications. Eliminate prop 
              drilling and manage chat state globally with full TypeScript support.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Debug and monitor your AI applications with real-time insights into tool calls, 
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Battle-tested tools used in production applications. Optimized for performance, 
              reliability, and scalability in real-world AI applications.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Full TypeScript support with intelligent autocompletion, type safety, 
              and comprehensive type definitions for all AI SDK tools.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              ...
              Compatible with SSR, concurrent features, and edge runtime environments.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-8 mb-40">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="space-y-4">
              <div className="text-xs text-secondary">◇ Store (State Management)</div>
      ...
      {messages.map(msg => (
        <div key={msg.id}>
          {msg.content}
            ...
            <div className="space-y-4">
              <div className="text-xs text-secondary">◇ Devtools (Debugging)</div>
              <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-6 h-[20rem] overflow-y-auto">
                <pre
                  className="text-xs text-[#d4d4d4] leading-relaxed"
                  dangerouslySetInnerHTML={{
...
// - Error handling`)
            ...
            <div className="space-y-4">
              <div className="text-xs text-secondary">◇ Artifacts (File Handling)</div>
              <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-6 h-[20rem] overflow-y-auto">
                <pre
                  className="text-xs text-[#d4d4d4] leading-relaxed"
                  dangerouslySetInnerHTML={{
