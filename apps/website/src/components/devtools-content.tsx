        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40">
          <div className="space-y-12">
            ...
            <div className="flex items-center justify-between border border-dashed border-[#2a2a2a] px-3 py-1.5 max-w-md">
              <span className="text-[#d4d4d4] text-xs font-mono">npm i @ai-sdk-tools/devtools</span>
              <button
                type="button"
                onClick={() => navigator.clipboard.writeText('npm i @ai-sdk-tools/devtools')}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-40">
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Track AI tool calls and responses in real-time with detailed insights 
              into performance and behavior patterns.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Monitor response times, token usage, and resource consumption 
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Catch and analyze errors in your AI workflows with detailed 
          ...
          <div>
            ...
            <p className="text-xs text-secondary font-light leading-relaxed">
              Integrates into your development environment like react-query-devtools. 
              Automatically detects development mode for seamless debugging.
            </p>
          </div>
          
          <div>
            <h3 className="text-base font-medium mb-3">Zero Production Impact</h3>
            <p className="text-xs text-secondary font-light leading-relaxed">
...
// - Token usage`)
            ...
            <div className="space-y-4">
              <div className="text-xs text-secondary">◇ Advanced Configuration</div>
              <div className="bg-[#0f0f0f] border border-[#2a2a2a] p-6 h-[32rem] overflow-y-auto">
                <pre
                  className="text-xs text-[#d4d4d4] leading-relaxed"
                  dangerouslySetInnerHTML={{
