    ...
    <div className="min-h-screen bg-black text-white">
      <div className="max-w-6xl mx-auto px-4 py-12 space-y-12">
        ...
        <div className="text-center space-y-6">
          <h1 className="text-5xl font-bold tracking-tight">AI SDK Store</h1>
          ...
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-4 max-w-md mx-auto font-mono text-sm">
            ...
            <div>
              ...
              <span className="text-white">@ai-sdk-tools/store</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="bg-black border border-gray-700 rounded p-4 font-mono text-sm">
                ...
                <span className="text-white">{"{ useChat }"}</span>{" "}
                <div className="text-blue-400">from</div>{" "}
                <span className="text-green-400">'@ai-sdk/react'</span>
            ...
            <div>
              ...
              <div className="bg-black border border-gray-700 rounded p-4 font-mono text-sm">
                ...
                <span className="text-white">{"{ useChat }"}</span>{" "}
                <div className="text-blue-400">from</div>{" "}
                <span className="text-green-400">'ai-sdk-zustand'</span>
        ...
        <footer className="text-center text-gray-400 text-sm border-t border-gray-800 pt-8">
          <p>
            Built with ai-sdk-zustand • Drop-in replacement for @ai-sdk/react
            with global state
          </p>
        </footer>
      </div>
